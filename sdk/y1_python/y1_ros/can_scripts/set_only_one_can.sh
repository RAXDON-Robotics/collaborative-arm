...
echo -e "SUBSYSTEM==\"tty\", ATTRS{idVendor}==\"$idVendor\", ATTRS{idProduct}==\"$idProduct\", ATTRS{serial}==\"$serial_number\", SYMLINK+=\"raxdon_y1_can0\"" > raxdon_y1_can.rules
...
echo "/dev/raxdon_y1_can0 symlink created!"